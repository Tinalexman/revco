  ...
  return (
    <div className="w-[100vw] lg:h-[100vh] bg-[url('../../public/image_263.png')] bg-cover bg-center bg-no-repeat">
      <div className="w-full h-full overflow-y-scroll xs:pb-2 xs:px-0 lg:px-10 xl:px-16 2xl:px-20 3xl:px-24 4xl:px-32 flex flex-col items-center bg-background bg-opacity-[0.95] relative">
        <div
          className="xs:left-0 xs:right-0 lg:left-10 lg:right-10 xl:left-16 xl:right-16 2xl:left-20 2xl:right-20 3xl:left-24 3xl:right-24 4xl:left-32 4xl:right-32 lg:pt-6  3xl:pt-8 xs:py-2 z-50 fixed xs:bg-background lg:bg-transparent border-b border-neutral-3"
          style={{
        ...
        <div className="py-10 xs:mt-20 lg:mt-28 xl:mt-24 2xl:mt-60 3xl:mt-72 4xl:mt-96 w-full grid place-content-center">
          {children}
        </div>
